...
class GoalRemoveScene1(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene2(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene3(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene4(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene5(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene6(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene7(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene8(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene9(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class GoalRemoveScene10(InitialSceneTemplates):
    def __init__(self):
...
def main():
    ...
    # task 10
    scene_name = "goal_remove_scene10"
    language = "turn_on_the_stove".replace("_", " ")
    register_task_info(
        language,
        scene_name=scene_name,
    ...
    BDDL_FILE_PATH = "./libero/libero/bddl_files/libero_goal_OOD_remove_object"
