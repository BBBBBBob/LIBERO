...
class ObjectSwapScene1(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene2(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene3(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene4(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene5(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene6(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene7(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene8(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene9(InitialSceneTemplates):
    def __init__(self):
...
@register_mu(scene_type="general")
class ObjectSwapScene10(InitialSceneTemplates):
    def __init__(self):
...
def main():
    ...
    # task 10
    scene_name = "object_swap_scene10"
    ...
    BDDL_FILE_PATH = "./libero/libero/bddl_files/libero_object_OOD_swap"
